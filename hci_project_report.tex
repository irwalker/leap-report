...
%the detection and modelling software is really what sets the Leap Motion apart. 
...
% with its ridiculously small size I 

%Personally however, it was after getting started that I began to notice issues and annoyances interacting with the Leap Motion device.

%As an interaction device my conclusion is that the software is still at the novelty-device stage. 
